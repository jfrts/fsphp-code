...
class AccountSaving extends Account
{
    ...
    public function __construct(int $branch, int $account, User $client, float $balance)
    {
    ...
    public function withdraw(float $value)
    {
        if ($this->balance >= $value) {
            ...
            Trigger::show("Saldo insuficiente, você tem {$this->toBrl($this->balance)}!", Trigger::ERROR);
        }
    }
